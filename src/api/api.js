import { getAction,deleteAction,putAction,postAction, patchAction, downFile} from '@/api/manage'
...
//工作流接口
const queryProcess = (params)=>getAction("/sys/process/queryById",params);
...
//文件管理
const queryFile = (params)=>getAction("/sys/user/queryUserFile",params);
...
//机构管理
const queryOrganAll = (params)=>getAction("/sys/organ/listForAll",params);
