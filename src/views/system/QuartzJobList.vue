    ...
    methods: {
      ...
      pauseJob: function(record){
        ...
        this.$confirm({
          ...
          content:"是否暂停选中任务?",
          onOk: function(){
            getAction(that.url.pause,{jobClassName:record.jobClassName,parameter:record.parameter}).then((res)=>{
              if(res.success){
      ...
      resumeJob: function(record){
        ...
        this.$confirm({
          ...
          content:"是否启动选中任务?",
          onOk: function(){
            getAction(that.url.resume,{jobClassName:record.jobClassName,parameter:record.parameter}).then((res)=>{
              if(res.success){
                that.$message.success(res.message);
                that.loadData();
                that.onClearSelected();
