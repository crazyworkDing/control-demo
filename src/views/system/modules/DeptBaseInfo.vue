  ...
  <a-card :visible="visible">
    <a-form :form="form">
      <a-form-item
        ...
        :hidden="false"
        label="名称">
        <a-input  placeholder="" v-decorator="['departName', {}]"/>
      </a-form-item>
      <a-form-item
        :labelCol="labelCol"
        :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      open(record) {
        ...
        console.log(record);
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(record, 'orgCategory','departName', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo', 'manageId'));
        });
      },
      clearForm() {
        this.form.resetFields();
