  ...
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      ...
      <div class="foot text-left">
        <span style="color: #57AAFF; font-size: 15px;cursor: pointer;" @click="$router.push('/register')">立即注册</span>
        <span style="color: #57AAFF; font-size: 15px;cursor: pointer; margin-left: 240px" @click="$router.push('/')">忘记密码</span>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      loginSuccess () {
        ...
        this.$router.push('/ileague/zxProductList')
