    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="可信维度" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['credibleDimension']" :trigger-change="true" dictCode="credible_dimension" placeholder="请选择可信维度"/>
        </a-form-item>
        <a-form-item label="用户号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'userId', validatorRules.userId]" placeholder="请输入用户号"></a-input>
        </a-form-item>
        <a-form-item label="可信值" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'credibleValue', validatorRules.credibleValue]" placeholder="请输入可信值"></a-input>
        </a-form-item>
        ...
        <a-form-item label="到期日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择到期日期" v-decorator="[ 'expireDate', validatorRules.expireDate]" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
