    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="姓名" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'username']" disabled placeholder="请输入姓名"></a-input>
        </a-form-item>
        <a-form-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'telephone']" disabled placeholder="请输入手机号码"></a-input>
        </a-form-item>
        <a-form-item label="部门" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'depart']" disabled placeholder="请输入部门"></a-input>
        </a-form-item>
        <a-form-item label="职务" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'post']" disabled placeholder="请输入职务"></a-input>
        </a-form-item>
        <a-form-item label="邮箱" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'email']" disabled placeholder="请输入邮箱"></a-input>
        </a-form-item>
        <!-- <a-form-item
          label="角色分配"
          :labelCol="labelCol"
        ...
        <a-form-item label="签约文件" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="action=='用户注册'">
          <div v-for="(item, index) in fileList" :key="index"><a href="javascipt:;" @click="downloadFile(item)">{{item.fileName}}</a></div>
         </a-form-item> 
        <a-form-item v-if="!flag">
...
import { queryProcess, queryUserRole, queryall, queryFile } from '@/api/api'
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      that.flag = record.review
      that.userId = record.id
      that.dataId = record.dataId
      that.visible = true
      that.model = Object.assign({}, record)
      that.action = record.action
      that.$nextTick(() => {
