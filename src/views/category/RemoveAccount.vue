<template>
  <a-card :bordered="false">
           ...
           <template >
             <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
               <a-form-item label="会员类型">
                 <a-input placeholder="请输入会员类型" v-model="queryParam.memberType"></a-input>
               </a-form-item>
             </a-col> -->
             <a-col :xl="6" :lg="7" :md="8" :sm="24">
             ...
             <a-form-item label="手机号码">
               <a-input placeholder="请输入手机号码" v-model="queryParam.telephone"></a-input>
             </a-form-item>
           </a-col>
             <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <!-- <user-modal-remove ref="modalForm" @ok="modalFormOk"></user-modal-remove> -->
  </a-card>
</template>

<script>
  import UserModalRemove from './modules/UserModalRemove'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          list: "/sys/user/listForAdmin",
          delete: "/sys/user/deleteForAdmin",
    ...
    methods: {
      ...
      handleChangePassword(telephone) {
        this.$refs.passwordmodal.show(telephone);
      },
      handleAgentSettings(telephone){
        this.$refs.sysUserAgentModal.agentSettings(telephone);
